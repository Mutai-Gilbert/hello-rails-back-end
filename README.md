...
**hello-rails-back-end** is app build using ruby on rails and react ([react-repo](https://github.com/Mutai-Gilbert/hello-rails-back-end))
...
Feel free to check the [issues page](https://github.com/Mutai-Gilbert/hello-rails-back-end.git).
